...
public partial class ChatClient
{
    ...
    /// <summary>
    ///     Generates a completion for the given chat and returns raw JSON responses. The completion is streamed back token by token as it is being
    ///     generated by the model instead of waiting for it to be finished first.
    /// </summary>
    /// <remarks>
    ///     <see cref="AsyncCollectionResult{T}"/> implements the <see cref="IAsyncEnumerable{T}"/> interface and can be
    ///     enumerated over using the <c>await foreach</c> pattern.
    ///     This method returns raw JSON objects as BinaryData instead of strongly-typed StreamingChatCompletionUpdate objects.
    /// </remarks>
    /// <param name="messages"> The messages comprising the chat so far. </param>
    /// <param name="options"> The options to configure the chat completion. </param>
    /// <param name="cancellationToken"> A token that can be used to cancel this method call. </param>
    /// <exception cref="ArgumentNullException"> <paramref name="messages"/> is null. </exception>
    /// <exception cref="ArgumentException"> <paramref name="messages"/> is an empty collection, and was expected to be non-empty. </exception>
    public virtual AsyncCollectionResult<BinaryData> CompleteChatStreamingRawAsync(IEnumerable<ChatMessage> messages, ChatCompletionOptions options = null, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNull(messages, nameof(messages));
    ...
    public virtual AsyncCollectionResult<BinaryData> CompleteChatStreamingRawAsync(BinaryContent content, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNull(content, nameof(content));

        var options = cancellationToken.ToRequestOptions(streaming: true);

        return CompleteChatStreamingRawAsync(content, options);
    }
    ...
    /// <remarks>
    ///     <see cref="CollectionResult{T}"/> implements the <see cref="IEnumerable{T}"/> interface and can be
    ///     enumerated over using a foreach loop.
    ///     This method returns raw JSON objects as BinaryData instead of strongly-typed StreamingChatCompletionUpdate objects.
    /// </remarks>
    /// <param name="messages"> The messages comprising the chat so far. </param>
    /// <param name="options"> The options to configure the chat completion. </param>
    ...
    /// <exception cref="ArgumentNullException"> <paramref name="messages"/> is null. </exception>
    /// <exception cref="ArgumentException"> <paramref name="messages"/> is an empty collection, and was expected to be non-empty. </exception>
    public virtual CollectionResult<BinaryData> CompleteChatStreamingRaw(IEnumerable<ChatMessage> messages, ChatCompletionOptions options = null, CancellationToken cancellationToken = default)
    {
        Argument.AssertNotNull(messages, nameof(messages));
    ...
    /// <exception cref="ArgumentNullException"> <paramref name="messages"/> is null. </exception>
    /// <exception cref="ArgumentException"> <paramref name="messages"/> is an empty collection, and was expected to be non-empty. </exception>
    public virtual AsyncCollectionResult<BinaryData> CompleteChatStreamingRawAsync(params ChatMessage[] messages)
        => CompleteChatStreamingRawAsync(messages, default(ChatCompletionOptions));
    ...
    /// <exception cref="ArgumentNullException"> <paramref name="messages"/> is null. </exception>
    /// <exception cref="ArgumentException"> <paramref name="messages"/> is an empty collection, and was expected to be non-empty. </exception>
    public virtual CollectionResult<BinaryData> CompleteChatStreamingRaw(params ChatMessage[] messages)
        => CompleteChatStreamingRaw(messages, default(ChatCompletionOptions));
