...
public partial class ChatClient
{
    ...
    ///     enumerated over using the <c>await foreach</c> pattern.
    /// </remarks>
    /// <param name="content"> The binary content representing the chat completion request. </param>
    /// <param name="cancellationToken"> A token that can be used to cancel this method call. </param>
    /// <returns> An asynchronous collection of raw <see cref="BinaryData"/> objects representing the streaming response chunks. </returns>
